...
const RestItems = () => {
  ...
  function startLoadingMore() {
    let timer;
    timer = setTimeout(() => setLoadingState(true), setMoreItems({state : true, pageToken : MoreItems.pageToken, noMoreITems : false}), 300)
    ...
    <div role="status" className="h-[80px] flex justify-center items-center relative dark:bg-dark-color bg-white " ref={restItemsRef}>
      ...
      >
        ...
        <path
          ...
          fill="currentFill"
        />
      </svg>) : (<button className="px-3 py-2 dark:bg-white bg-black dark:text-black text-white capitalize rounded-md active:scale-95"
